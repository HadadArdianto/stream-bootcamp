      ...
      <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.update', $movie->id) }}">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="trailer" name="movie" value="{{ $movie->movie }}" placeholder="Video url">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="short-about" name="short_about" value="{{ $movie->about }}" placeholder="Awesome Movie">
          </div>
          <div class="form-group">
