      ...
      <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.store') }}">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="movie" name="movie" value="{{ old('movie') }}" placeholder="1h 39m">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group date" id="release-date" data-target-input="nearest">
              <input type="text" name="release_date" value="{{ old('release-date') }}" class="form-control datetimepicker-input" data-target="#release-date"/>
